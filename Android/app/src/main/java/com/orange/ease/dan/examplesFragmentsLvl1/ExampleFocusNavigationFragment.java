...
public class ExampleFocusNavigationFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mHeaderCriteriaWhyDescription.setText(R.string.criteria_focusnav_why_description);
        mHheaderCriteriaRuleLabel.setText(R.string.criteria_template_rule);
        mHeaderCriteriaRuleDescription.setText(R.string.criteria_focusnav_rule_description);
        mHeaderCriteriaListLabel.setText(R.string.criteria_template_example);

        String[] items = getResources().getStringArray(R.array.criteria_focusnav_list);
    ...
    public void onResume() {
        super.onResume();
        mOnNewFragment.setTemplateTitle(getString(R.string.criteria_focusnav_title),true);
    }
}
