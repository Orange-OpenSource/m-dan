...
public class GuideDevTalkbackFragment extends Fragment {
    ...
    void updateViews() {
        ...
        mTextViewDescriptionContentGuideDev.setText(Html.fromHtml(getString(R.string.dev_description_detect).replace("\n","<br />")));
        mTextViewTitleLinksGuideDev.setVisibility(View.GONE);
        mTextViewContentLinksGuideDev.setVisibility(View.GONE);
    }

    @Override
    public void onResume() {
        super.onResume();
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.dev_title_detect);
    }
}
