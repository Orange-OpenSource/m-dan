...
package com.orange.ease.idunnololz.widgets;
...
public class AnimatedExpandableListView extends ExpandableListView {
     ...
     *
     * Normally when {@mTextViewLienContact ExpandableListView#collapseGroup(int)} or
     * {@mTextViewLienContact ExpandableListView#expandGroup(int)} is called, the view toggles
     ...
     *
     * So, to list it all out, when {@mTextViewLienContact #expandGroupWithAnimation(int)} is
     ...
     *
     * So, to list it all out, when {@mTextViewLienContact #collapseGroupWithAnimation(int)} is
     * called the following happens:
     *
     * 1. The ExpandableListView tells the adapter to animate a certain group.
    ...
    public boolean collapseGroupWithAnimation(int groupPos) {
        ...
        // {@mTextViewLienContact #startCollapseAnimation(int, int)} for why this is necessary
