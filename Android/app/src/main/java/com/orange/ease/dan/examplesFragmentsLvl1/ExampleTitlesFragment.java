...
import com.orange.ease.dan.examplesFragmentsLvl2.ExTitles1Fragment_;
...
public class ExampleTitlesFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mHeaderCriteriaWhyDescription.setText(R.string.criteria_title_why_description);
        mHheaderCriteriaRuleLabel.setText(R.string.criteria_template_rule);
        mHeaderCriteriaRuleDescription.setText(R.string.criteria_title_rule_description);
        mHeaderCriteriaListLabel.setText(R.string.criteria_template_example);

        String[] items = getResources().getStringArray(R.array.criteria_title_list);
    ...
    public void onResume() {
        super.onResume();
        mOnNewFragment.setTemplateTitle(getString(R.string.criteria_title_title),true);
    }
}
