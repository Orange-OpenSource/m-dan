...
public class GuideDevAltFragment extends Fragment {
    ...
    void updateViews() {
        ...
        mTextViewDescriptionContentGuideDev.setText(R.string.dev_description_alt);
        mTextViewTitleLinksGuideDev.setText(R.string.dev_link);
        mTextViewContentLinksGuideDev.setText(R.string.dev_lien_alt);
    }

    @Override
    public void onResume() {
        super.onResume();
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.dev_title_alt);
    }
}
