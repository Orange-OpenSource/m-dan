...
import static com.orange.ease.dan.R.string.criteria_horizontalscroll_rule_description;
import static com.orange.ease.dan.R.string.criteria_horizontalscroll_title;
...
public class ExampleScrollFragment extends ABaseCriteriaListFragment {
    ...
    protected int getWhyDescription() {
        return criteria_horizontalscroll_why_description;
    }

    @Override
    protected int getRuleDescription() {
        return criteria_horizontalscroll_rule_description;
    }

    @Override
    protected int getListArray() {
        return criteria_scroll_list;
    }

    @Override
    protected int getTitleResource() {
        return criteria_horizontalscroll_title;
    }
