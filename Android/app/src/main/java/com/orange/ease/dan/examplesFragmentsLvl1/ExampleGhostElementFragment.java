...
import com.orange.ease.dan.examplesFragmentsLvl2.ExGhost1Fragment_;
...
public class ExampleGhostElementFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mHeaderCriteriaWhyDescription.setText(R.string.criteria_ghostelement_why_description);
        mHheaderCriteriaRuleLabel.setText(R.string.criteria_template_rule);
        mHeaderCriteriaRuleDescription.setText(R.string.criteria_ghostelement_rule_description);
        mHeaderCriteriaListLabel.setText(R.string.criteria_template_example);

        String[] items = getResources().getStringArray(R.array.criteria_ghostelement_list);
    ...
    public void onResume() {
        super.onResume();
        mOnNewFragment.setTemplateTitle(getString(R.string.criteria_ghostelement_title),true);
    }
}
