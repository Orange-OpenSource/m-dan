...
public class ExImg2Fragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mTextViewTitleExample.setText(R.string.criteria_img_ex2_title);
        mTextViewDescriptionExample.setText(R.string.criteria_img_ex2_description);
        ...
        LinearLayout myView = (LinearLayout) inflater.inflate(R.layout.eximg2_tuile, null);
        mFrameLayoutExampleAxsYes.addView(myView);

        mTextViewTitleExempleAxsNo.setText(R.string.criteria_not_accessible_example);

        LinearLayout myView2 = (LinearLayout) inflater.inflate(R.layout.eximg2_tuile, null);

        mFrameLayoutExampleAxsNo.addView(myView2);

        ImageView axsNo = (ImageView) getView().findViewById(R.id.imageView6);
        axsNo.setContentDescription("");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            axsNo.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_NO);
        }
    }
