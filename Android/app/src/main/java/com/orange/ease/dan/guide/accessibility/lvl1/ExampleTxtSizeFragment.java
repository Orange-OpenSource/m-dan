...
import static com.orange.ease.dan.R.string.criteria_textsize_rule_description;
...
@EFragment
public class ExampleTxtSizeFragment extends BaseCriteriaListFragment {

    @Override
    protected int getWhyDescription() {
        return criteria_textsize_why_description;
    }

    @Override
    protected int getRuleDescription() {
        return criteria_textsize_rule_description;
    }

    @Override
    protected int getListArray() {
        return criteria_textsize_list;
    }

    @Override
    protected int getTitleResource() {
        return criteria_textsize_title;
    }
