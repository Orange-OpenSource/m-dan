...
public class ExampleImgFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mHeaderCriteriaWhyDescription.setText(R.string.criteria_img_why_description);
        mHheaderCriteriaRuleLabel.setText(R.string.criteria_template_rule);
        mHeaderCriteriaRuleDescription.setText(R.string.criteria_img_rule_description);
        mHeaderCriteriaListLabel.setText(R.string.criteria_template_example);


        String[] items = getResources().getStringArray(R.array.criteria_img_list);
    ...
    public void onResume() {
        super.onResume();
        mOnNewFragment.setTemplateTitle(getString(R.string.criteria_img_title),true);
    }
}
