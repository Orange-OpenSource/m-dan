...
import com.orange.ease.dan.examplesFragmentsLvl2.ExSizeTxt1Fragment_;
...
public class ExampleTxtSizeFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mHeaderCriteriaWhyDescription.setText(R.string.criteria_textsize_why_description);
        mHheaderCriteriaRuleLabel.setText(R.string.criteria_template_rule);
        mHeaderCriteriaRuleDescription.setText(R.string.criteria_textsize_rule_description);
        mHeaderCriteriaListLabel.setText(R.string.criteria_template_example);

        String[] items = getResources().getStringArray(R.array.criteria_textsize_list);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            case 1:
                newFragment = new ExSizeTxt1Fragment_();
                break;
            default:
                break;
        }
    ...
    public void onResume() {
        super.onResume();
        mOnNewFragment.setTemplateTitle(getString(R.string.criteria_textsize_title),true);
    }
}
