...
public class GuideDevAxsEvenmentsFragment extends Fragment {
    ...
    void updateViews() {
        ...
        mTextViewDescriptionContentGuideDev.setText(R.string.dev_description_axsevents);
        mTextViewTitleLinksGuideDev.setText(R.string.dev_links);
        mTextViewContentLinksGuideDev.setText(R.string.dev_lien_axsevents);
    }

    @Override
    public void onResume() {
        super.onResume();
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.dev_title_axsevents);
    }
}
