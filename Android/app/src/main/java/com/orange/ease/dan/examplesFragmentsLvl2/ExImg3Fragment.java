...
public class ExImg3Fragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mTextViewTitleExample.setText(R.string.criteria_img_ex3_title);
        mTextViewDescriptionExample.setText(R.string.criteria_img_ex3_description);
        ...
        LinearLayout myView = (LinearLayout) inflater.inflate(R.layout.eximg3_frag, null);
        ...
        ImageView axsNo = (ImageView) getView().findViewById(R.id.imageView7);
        axsNo.setContentDescription("");

        ImageButton edit = (ImageButton) getView().findViewById(R.id.imageButtonedit);
        edit.setContentDescription(getString(R.string.criteria_img_ex3_cd_btn_edit));

        ImageButton settings = (ImageButton) getView().findViewById(R.id.imageButtonsettings);
        settings.setContentDescription(getString(R.string.criteria_img_ex3_cd_btn_parameters));
    }
