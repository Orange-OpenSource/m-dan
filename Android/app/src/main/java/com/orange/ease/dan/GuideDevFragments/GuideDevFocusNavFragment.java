...
public class GuideDevFocusNavFragment extends Fragment {
    ...
    void updateViews() {
        ...
        mTextViewDescriptionContentGuideDev.setText(R.string.dev_description_focusnav);
        mTextViewTitleLinksGuideDev.setText(R.string.dev_link);
        mTextViewContentLinksGuideDev.setText(R.string.dev_lien_focusnav);
    }

    @Override
    public void onResume() {
        super.onResume();
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.dev_title_focusnav);
    }
}
