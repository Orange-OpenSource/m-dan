...
public class ExStateElmts3Fragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mTextViewTitleExample.setText(R.string.criteria_stateelement_ex3_title);
        mTextViewDescriptionExample.setText(R.string.criteria_stateelement_ex3_description);
