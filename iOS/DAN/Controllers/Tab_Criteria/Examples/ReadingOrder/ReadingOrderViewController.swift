...
class ReadingOrderViewController: DefaultTableViewController {

    let textCellIdentifier          = "textCell"
    let remoteControlCellIdentifier = "remoteControlCell"
    ...
    override func setUpDatas() {
        ...
        cellsContent = [
            ["example_readingOrder_remoteControl_description"],
            [""],
            [""]
        ]
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (indexPath as NSIndexPath).section == 0 {
            ...
            let cell: RemoteControlTableViewCell = tableView.dequeueReusableCell(withIdentifier: remoteControlCellIdentifier, for: indexPath) as! RemoteControlTableViewCell
            
            if (indexPath as NSIndexPath).section != notAccessibleSection {
                cell.renderAccessible()
            }
