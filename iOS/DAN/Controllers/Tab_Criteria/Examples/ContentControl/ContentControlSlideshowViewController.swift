...
class ContentControlSlideshowViewController: DefaultTableViewController {
    ...
    override func setUpDatas() {
        ...
        cellsContent = [
            ["example_contentControl_slideshow_description"],
            [""],
            [""]
        ]
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (indexPath as NSIndexPath).section == 0 {
            ...
            buttonCell.button.setTitle("example_contentControl_slideshow_buttonText".localized, for: UIControl.State())
            buttonCell.button.tag                   = (indexPath as NSIndexPath).section // allow to differenciate buttons while preparing for segue
            buttonCell.button.accessibilityLabel    = (indexPath as NSIndexPath).section == accessibleSection ? "example_contentControl_slideshow_buttonLabelAccessible".localized : "example_contentControl_slideshow_buttonLabelNonAccessible".localized
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let carouselVC          = segue.destination as! SlideshowViewController
